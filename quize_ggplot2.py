...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    gg =  ggplot(data, aes('yearID', 'HR', color = 'teamID'))+geom_point()+geom_line()+ggtitle('Total HR by year')+xlab('Year')+ylab('HR')
    return gg


hr_year_csv = 'hr_by_team_year_sf_la.csv'
print lineplot_compare(hr_year_csv)